<?php
    ...
    $query = "SELECT inventoryID, Pname FROM APPAREL_INVENTORY WHERE inventoryID IN ('".$in."')";
    ...
    <body style='text-align: center;'>
        ...
        <?php
            ...
            for ($i=0; $i <$num_results; $i++) {
                ...
                <p>
                    <form action='process/remove_from_cart.php?id=".$row['inventoryID']."' method='post'>
                        <b>Product ID:</b> ".$row['inventoryID']."
                        <br>
                        <b>Name:</b> ".$row['Pname']."
                        <br>
